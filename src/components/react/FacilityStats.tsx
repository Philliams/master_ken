    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
      {stats.map((stat, index) => {
        ...
        return (          <div
          ...
          >
            <div className="w-16 h-16 mx-auto mb-4 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg" style={{ background: 'linear-gradient(135deg, #9f3434, #8d7051)' }}>
              <IconComponent className="w-8 h-8 text-white" />
            </div>
            <div className="text-3xl md:text-4xl font-bold mb-2" style={{ background: 'linear-gradient(to right, #9f3434, #8d7051)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
              {stat.value}
            </div>
